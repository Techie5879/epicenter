...
export const commands = {
	...
	openLocalModels: () => __TAURI_INVOKE<void>('open_local_models'),
	...
	completeCodexOauthLogin: (authorizeUrl: string, expectedState: string) =>
		typedError<string, CodexOAuthCallbackError>(
			__TAURI_INVOKE('complete_codex_oauth_login', {
				authorizeUrl,
				expectedState,
			}),
		),
